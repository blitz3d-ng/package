...
While Not KeyDown( 1 )
  ...
  If KeyHit( 11 )=True
    ...
    If tex0_blend=4 Then tex0_blend_info$="dot3"
    If tex0_blend=5 Then tex0_blend_info$="multiply2"
    If tex0_blend=6 Then tex0_blend=0
  EndIf
  ...
  If KeyHit( 2 )=True
    ...
    If tex1_blend=4 Then tex1_blend_info$="dot3"
    If tex1_blend=5 Then tex1_blend_info$="multiply2"
    If tex1_blend=6 Then tex1_blend=0
  EndIf
