...
RUN apt-get update
RUN apt-get install -y curl build-essential libwxgtk3.0-dev libwxgtk-webview3.0-dev libglfw3-dev libglew-dev libxcursor-dev libxrandr-dev libxinerama-dev cmake libxml2-dev zlib1g-dev libssl-dev libreadline-dev libgdbm-dev openssl
